# Plan de implementación mejorado — Rediseño integral del repositorio
...
>
> **Versión:** 2.0 ampliada · Junio 2026.
>
...
- [ ] El sitio corre en local y en preview de GitHub Pages.
...
### 4.2 Rutas de aplicación

Usar hash routing para compatibilidad directa con GitHub Pages:
...
## 25. Prompt operativo corto para Antigravity

Usar este resumen si se necesita dar una instrucción inicial breve al agente:

> Refactorice el repositorio de la Caja de Herramientas de IA para MiPYMES desde una página monolítica hacia una plataforma estática modular compatible con GitHub Pages. Implemente arquitectura `Inicio → Módulo → Semana → Unidad de contenido`, con una sola unidad visible por pantalla, progreso local en `localStorage`, diagnóstico persistente, rutas sugeridas, glosario, biblioteca de recursos, portafolio local de evidencias y accesibilidad WCAG 2.1 AA. No elimine contenido ni funcionalidades. No prometa carga real de archivos ni base de datos en la V1. Mantenga identidad UCR/CIOdD/DIPROVID, preserve el marco pedagógico RHEC/CIFRCE/HITL/70-30 y documente toda migración con pruebas de paridad de contenido.

---

## 26. Anexo A — Mapa de hallazgos a fases
...
## 28. Anexo C — Mensajes de interfaz recomendados
